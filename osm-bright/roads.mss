...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [zoom=13] {
    [stylegroup='motorway'] { line-width: @rdz13_maj + 4;}
  ...
  [zoom=14] {
    [stylegroup='motorway'] { line-width: @rdz14_maj + 4; }
  ...
  [zoom=15] {
    [stylegroup='motorway'] { line-width: @rdz15_maj + 4;}
  ...
  [zoom=16] {
    [stylegroup='motorway'] { line-width: @rdz16_maj + 4;}
